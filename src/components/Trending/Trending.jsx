...
export default function Trending() {
    ...
    return (
        <div className='trendingSection  my-12  ' data-aos="fade-up">
            ...
            <div className='container grid grid-cols-1 md:grid-cols-3 gap-6 items-center justify-center '>
                ...
                <div className='col-span-2 flex justify-center'>
                    <div className='rightProducts  grid grid-cols-1 gap-4 md:grid-cols-2 '>
