...
export default function Subscribe() {
    return (
        <div className='subSection my-12 '  data-aos="fade-up">
                ...
                <div className="relative z-10 text-white p-8 flex justify-center items-center h-full">
                    <div className='text-center'>
                        ...
                        <div className='relative '>
                            ...
                            <button className='bg-[var(--brownish)] transition absolute right-1 py-2.5 px-4 rounded top-1.5 text-xs font-[roboto] hover:bg-amber-900 font-semibold '>Submit</button>
                        </div>
                    </div>
                </div>
            </div>
